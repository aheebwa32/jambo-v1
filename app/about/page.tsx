    ...
    <>
      ...
      <main style={{ paddingTop: 72 }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 24px 80px" }}>
          ...
          {/* Héro */}
          <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center", marginBottom: 80 }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
                <Image src="/images/city-taxi.png" alt="CityTaxi" width={130} height={40} style={{ objectFit: "contain", mixBlendMode: "screen", backgroundColor: "transparent" }} />
            ...
            <div style={{ borderRadius: 16, overflow: "hidden", position: "relative", aspectRatio: "4/3" }}>
              <Image src="/images/vehicules.jpg" alt="Flotte Jambo" fill style={{ objectFit: "cover" }} />
            </div>
          </section>
          ...
          {/* Nos valeurs */}
          <section style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 64, marginBottom: 80, alignItems: "start" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              ...
              <div style={{ ...G, borderRadius: 12, padding: 24, display: "flex", alignItems: "center", justifyContent: "center", height: 230 }}>
                <div style={{ textAlign: "center" }}>
                    <Image src="/images/city-taxi.png" alt="CityTaxi" width={140} height={50} style={{ objectFit: "contain", marginBottom: 12, mixBlendMode: "screen", backgroundColor: "transparent" }} />
